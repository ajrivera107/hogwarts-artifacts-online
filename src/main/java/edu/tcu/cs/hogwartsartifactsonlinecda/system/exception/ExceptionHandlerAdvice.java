package edu.tcu.cs.hogwartsartifactsonlinecda.system.exception;
...
public class ExceptionHandlerAdvice {
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "The access token provided is expired, revoked, malformed, or inavlid for other reasons.", ex.getMessage());
    }
