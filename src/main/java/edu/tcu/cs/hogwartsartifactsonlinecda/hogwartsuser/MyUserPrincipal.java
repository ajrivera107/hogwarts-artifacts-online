package edu.tcu.cs.hogwartsartifactsonlinecda.hogwartsuser;
...
public class MyUserPrincipal implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        // convert user's roles from space-delimited string to a list of SimpleGrantedAuthority object
        // e.g., John's roles are stored in a string like "admin user moderator", we need to convert it to a list of GrantedAuthority
        // before conversion, we need to add this "ROLE," prefix to each role name
