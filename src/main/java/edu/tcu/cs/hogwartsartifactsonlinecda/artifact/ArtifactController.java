...
import edu.tcu.cs.hogwartsartifactsonlinecda.artifact.converter.ArtifactDtoToArtifactConverter;
import edu.tcu.cs.hogwartsartifactsonlinecda.artifact.converter.ArtifactToArtifactDtoConverter;
...
public class ArtifactController {
    ...
    public Result findAllArtifacts(Pageable pageable) {
        Page<Artifact> artifactPage = (Page<Artifact>) this.artifactService.findAll(pageable);
